...
type OptionConverter() =
    ...
    override __.CanConvert(t) = 
        let res = t.IsGenericType && t.GetGenericTypeDefinition() = typedefof<option<_>>
        res
    ...
    override __.ReadJson(reader, t, existingValue, serializer) =        
        ...
        let maybe = if value = null then FSharpValue.MakeUnion(cases.[0], [||])
...
//                match values with
//                | [| null |] ->
//                    let none = unionCases |> Array.find(fun c -> c.GetFields().Length = 0)
//                    none
...
//            
//        let c = case
//        //let none = FSharpType.GetUnionCases(destinationType) |> Array.find(fun c -> c.GetFields().Length = 0)
//        let res = FSharpValue.MakeUnion(c, values)
//        res
//    
